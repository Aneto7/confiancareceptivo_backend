...
import com.confianca.services.TipoReceitaService;
...
public class TipoReceitaResource {
    ...
    public ResponseEntity<TipoReceita> find(@PathVariable Integer id) {
    ...
    public ResponseEntity<Void> insert(@RequestBody @Valid TipoReceita obj) {
    ...
    public ResponseEntity<Void> update(@Valid @RequestBody TipoReceita obj, @PathVariable Integer id) {
        obj.setId(id);
    ...
    public ResponseEntity<Page<TipoReceita>> findPage(
