...
import com.confianca.services.PaisService;
...
public class PaisResource {
    ...
    public ResponseEntity<Void> insert(@RequestBody @Valid Pais obj) {
    ...
    public ResponseEntity<Void> update(@Valid @RequestBody Pais obj, @PathVariable Integer id) {
        obj.setId(id);
