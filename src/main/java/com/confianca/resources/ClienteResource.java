...
import com.confianca.services.ClienteService;
...
public class ClienteResource {
    ...
    @RequestMapping(value = "/solicitacaocadastro", method = RequestMethod.POST)
    public ResponseEntity<Void> solicitacaoCadastro(@Valid @RequestBody ClienteCadastroDTO obj) {
        System.out.println("Teste");
        emailService.sendSolicitacaoCadastro(obj);
        return ResponseEntity.noContent().build();
    }
