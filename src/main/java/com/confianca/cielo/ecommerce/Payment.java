...
public class Payment {
    ...
    public Payment(Integer amount, Integer installments, Currency currency, String country, String softDescriptor) {
        setAmount(amount);
        setInstallments(installments);
    ...
    public Payment(Integer amount, Integer installments, Currency currency, String softDescriptor) {
        setAmount(amount);
        setInstallments(installments);
        setCurrency(currency);
        setSoftDescriptor(softDescriptor);
